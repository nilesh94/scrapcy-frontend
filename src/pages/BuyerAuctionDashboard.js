...
const BuyerAuctionDashboard = () => {
  ...
  const isEligible = data?.participation?.payment_status === 'SUCCESS' && data?.auction?.status === 'LIVE';
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <RequirementItem 
                ...
                isDone={data?.participation?.payment_status === 'SUCCESS'} 
          ...
          <div className="bg-navy rounded-xl shadow-2xl p-8 text-white flex flex-col justify-center items-center text-center">
            {isEligible ? (
              <>
                ...
                <p className="text-gray-400 text-sm mb-6">You are a verified participant. All lots are open for simultaneous bidding.</p>
                <button 
                  onClick={() => navigate(`/api/v1/e-auction/live/${auctionId}`)}
                  className="w-full bg-orange hover:bg-white hover:text-navy text-white font-black py-4 rounded-lg transition-all transform hover:scale-105 shadow-xl"
                >
              ...
              <>
                ...
                {data?.participation?.payment_status !== 'SUCCESS' && (
